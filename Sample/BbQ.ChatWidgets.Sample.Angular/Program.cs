...
/// <summary>
/// BbQ.ChatWidgets Web API Sample Application (Angular)
/// 
/// This sample demonstrates:
/// - Using OpenAI chat client with BbQ.ChatWidgets
/// - ASP.NET Core Web API with chat endpoints
/// - Angular frontend consuming the chat API
...
logger.LogInformation("=== BbQ.ChatWidgets Web API Sample (Angular) ===");
...
logger.LogInformation("Angular frontend served from wwwroot/");
