...
public class ChatWidgetSerializationTests
{
    ...
    [Fact]
    public void SliderWidget_DeserializesNumbersFromStrings()
    {
        // Arrange - JSON with numbers as strings
    ...
    [Fact]
    public void ProgressBarWidget_DeserializesNumbersFromStrings()
    {
        // Arrange - JSON with numbers as strings
    ...
    [Fact]
    public void ImageWidget_DeserializesNumbersFromStrings()
    {
        // Arrange - JSON with numbers as strings
    ...
    [Fact]
    public void InputWidget_DeserializesMaxLengthFromString()
    {
        // Arrange - JSON with maxLength as string
