...
/// <summary>
/// Help agent that handles user support requests for the web API sample.
/// </summary>
...
/// <summary>
/// Data query agent that handles information requests for the web API sample.
/// </summary>
...
/// <summary>
/// Action agent that handles action requests for the web API sample.
/// </summary>
...
/// <summary>
/// Feedback agent that handles user feedback for the web API sample.
/// </summary>
